...
set _xil_proj_name_ "firmware-pueo-turfio"
...
set script_file "firmware-pueo-turfio.tcl"
...
# Create project
create_project ${_xil_proj_name_} $orig_proj_dir -part xc7a35tcsg325-2L
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35tcsg325-2L -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35tcsg325-2L -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
