...
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN P14 PULLDOWN TRUE} [get_ports {TXCLK_P[2] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN R15     } [get_ports {TXCLK_N[2] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN T14 PULLDOWN TRUE} [get_ports {TXCLK_P[1] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN T15     } [get_ports {TXCLK_N[1] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN R16 PULLDOWN TRUE} [get_ports {TXCLK_P[0] }]
...
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN N3 PULLDOWN TRUE} [get_ports {TXCLK_P[6] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN N2      } [get_ports {TXCLK_N[6] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN P4 PULLDOWN TRUE} [get_ports {TXCLK_P[5] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN P3      } [get_ports {TXCLK_N[5] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN R2 PULLDOWN TRUE} [get_ports {TXCLK_N[4] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN R1      } [get_ports {TXCLK_P[4] }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN R3 PULLDOWN TRUE} [get_ports {TXCLK_P[3] }]
