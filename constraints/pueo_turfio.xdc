...
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN A13 DIFF_TERM "TRUE" } [get_ports {T_CIN_P    }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN A14 DIFF_TERM "TRUE" } [get_ports {T_CIN_N    }]
...
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN D13 DIFF_TERM "TRUE"} [get_ports {T_RXCLK_N  }]
set_property -dict { IOSTANDARD LVDS_25 PACKAGE_PIN C13 DIFF_TERM "TRUE"} [get_ports {T_RXCLK_P  }]
...
create_clock -period 8.00 -name rx_clock [get_ports -filter { NAME =~ "T_RXCLK_N" && DIRECTION == "IN" }]
